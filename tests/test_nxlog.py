...
class TestProcessing(TestCase):
    ...
    def test_coords(self):
        _ips=['198.41.0.4', '192.33.4.12', '192.5.5.241', '192.36.148.17', '2001:500:9f::42', '2001:500:84::b' ]
        ret=list()
        for _ip in _ips:
            ret.append(nxlog.coords(_ip))
        self.assertEqual(ret, ['[38.9880981445, -77.4755020142]', '[38.0, -97.0]', '[38.0, -97.0]', '[59.3293991089, 18.0685997009]'] )
